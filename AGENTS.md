...
- **Phase 4** delivered the **product shell** layout ([`docs/prd/phase4.md`](docs/prd/phase4.md)); checklist **closed**. **Phase 5** wires **search + artist results** to **`searchArtists`** in [`src/shell/AppShell.tsx`](src/shell/AppShell.tsx) ([`docs/prd/phase5.md`](docs/prd/phase5.md)) — **manual validation** may still be open until the PRD checklist is marked. **Phase 6 PRD:** [`docs/prd/phase6.md`](docs/prd/phase6.md) — albums + album detail via **`getArtistAlbums`** / **`getAlbum`** (implementation next).
